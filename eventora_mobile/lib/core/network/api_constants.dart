class ApiConstants {
  ...
  static String organizerPayouts(int orgId) => '/organizer/$orgId/payouts';
  static String organizerTicketsSync(int orgId, int eventId) => '/organizer/$orgId/events/$eventId/tickets-sync';
}
